import { type ConformanceResult, runConformance } from "@openkarta/conformance-tests";
import { type EmailClient, makeResendClient, ulid } from "@openkarta/registry-shared";
import { type AgentHealthState, transition } from "./state-machine.js";
...
export function setEmailFactory(f: EmailFactory): void {
  emailFactoryImpl = f;
}
