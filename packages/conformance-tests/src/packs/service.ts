...
export const runServicePack = async (ctx: RunCtx): Promise<PackReport> => {
  ...
  results.push(
    await test("location-mode-variants", async () => {
  ...
  results.push(
    await test("provider-attribution", async () => {
  ...
  results.push(
    await test("duration-enforcement", async () => {
